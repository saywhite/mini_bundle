...
# IMGUI_API bool          BeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags window_flags);    /* original C++ signature */
def begin_child_ex(
    name: str, id_: ID, size_arg: ImVec2, border: bool, window_flags: WindowFlags
) -> bool:
    pass
...
def table_draw_context_menu(table: Table) -> None:
    pass

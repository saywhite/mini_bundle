...
void py_init_module_imgui_internal(py::module& m)
{
    ...
    m.def("im_clamp",
        ...
        {
            auto ImClamp_adapt_force_lambda = [](const ImVec2 & v, const ImVec2 & mn, ImVec2 mx) -> ImVec2
            {
    ...
    py::enum_<ImGuiHoveredFlagsPrivate_>(m, "HoveredFlagsPrivate_", py::arithmetic(), "Extend ImGuiHoveredFlags_")
        .value("im_gui_hovered_flags_delay_mask_", ImGuiHoveredFlags_DelayMask_, "")
        .value("im_gui_hovered_flags_allowed_mask_for_is_window_hovered", ImGuiHoveredFlags_AllowedMaskForIsWindowHovered, "")
        .value("im_gui_hovered_flags_allowed_mask_for_is_item_hovered", ImGuiHoveredFlags_AllowedMaskForIsItemHovered, "");
    ...
    py::enum_<ImGuiButtonFlagsPrivate_>(m, "ButtonFlagsPrivate_", py::arithmetic(), "Extend ImGuiButtonFlags_")
        ...
        .value("im_gui_button_flags_allow_overlap", ImGuiButtonFlags_AllowOverlap, "require previous frame HoveredId to either match id or be null before being usable.")
    ...
    py::enum_<ImGuiSliderFlagsPrivate_>(m, "SliderFlagsPrivate_", py::arithmetic(), "Extend ImGuiSliderFlags_")
        ...
        .value("im_gui_slider_flags_read_only", ImGuiSliderFlags_ReadOnly, "Consider using g.NextItemData.ItemFlags |= ImGuiItemFlags_ReadOnly instead.");
    ...
    auto pyClassImGuiDataTypeTempStorage =
        py::class_<ImGuiDataTypeTempStorage>
    ...
    auto pyClassImGuiPopupData =
        ...
        .def_readwrite("backup_nav_window", &ImGuiPopupData::BackupNavWindow, "Set on OpenPopup(), a NavWindow that will be restored on popup close")
    ...
    auto pyClassImGuiLastItemData =
        ...
        .def_readwrite("display_rect", &ImGuiLastItemData::DisplayRect, "Display rectangle (only if ImGuiItemStatusFlags_HasDisplayRect is set)")
        .def(py::init<>())
        ;
    ...
    auto pyClassImGuiKeyRoutingData =
        ...
        .def_readwrite("mods", &ImGuiKeyRoutingData::Mods, "Technically we'd only need 4-bits but for simplify we store ImGuiMod_ values which need 16-bits. ImGuiMod_Shortcut is already translated to Ctrl/Super.")
    ...
    py::enum_<ImGuiOldColumnFlags_>(m, "OldColumnFlags_", py::arithmetic(), "Flags for internal's BeginColumns(). Prefix using BeginTable() nowadays!")
    ...
    auto pyClassImGuiContext =
        ...
        .def_readwrite("active_id_using_all_keyboard_keys", &ImGuiContext::ActiveIdUsingAllKeyboardKeys, "")
        ...
        .def_readwrite("debug_log_clipper_auto_disable_frames", &ImGuiContext::DebugLogClipperAutoDisableFrames, "")
    ...
    auto pyClassImGuiWindowTempData =
        ...
        , py::arg("cursor_pos") = ImVec2(), py::arg("cursor_pos_prev_line") = ImVec2(), py::arg("cursor_start_pos") = ImVec2(), py::arg("cursor_max_pos") = ImVec2(), py::arg("ideal_max_pos") = ImVec2(), py::arg("curr_line_size") = ImVec2(), py::arg("prev_line_size") = ImVec2(), py::arg("curr_line_text_base_offset") = float(), py::arg("prev_line_text_base_offset") = float(), py::arg("is_same_line") = bool(), py::arg("is_set_pos") = bool(), py::arg("indent") = ImVec1(), py::arg("columns_offset") = ImVec1(), py::arg("group_offset") = ImVec1(), py::arg("cursor_start_pos_lossyness") = ImVec2(), py::arg("nav_layer_current") = ImGuiNavLayer(), py::arg("nav_layers_active_mask") = short(), py::arg("nav_layers_active_mask_next") = short(), py::arg("nav_is_scroll_pushable_x") = bool(), py::arg("nav_hide_highlight_one_frame") = bool(), py::arg("nav_window_has_scroll_y") = bool(), py::arg("menu_bar_appending") = bool(), py::arg("menu_bar_offset") = ImVec2(), py::arg("menu_columns") = ImGuiMenuColumns(), py::arg("tree_depth") = int(), py::arg("tree_jump_to_parent_on_pop_mask") = ImU32(), py::arg("current_table_idx") = int(), py::arg("layout_type") = ImGuiLayoutType(), py::arg("parent_layout_type") = ImGuiLayoutType(), py::arg("item_width") = float(), py::arg("text_wrap_pos") = float()
        )
    ...
    m.def("set_window_hiddend_and_skip_items_for_current_frame",
        ImGui::SetWindowHiddendAndSkipItemsForCurrentFrame, py::arg("window"));
    ...
    m.def("dock_builder_copy_dock_space",

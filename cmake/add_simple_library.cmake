set(MINIBUNDLE_EXTERNAL_PATH ${MINIBUNDLE_PATH}/external CACHE STRING "" FORCE)
...
function(add_simple_external_library lib_target_name lib_folder)
    ...
    set(lib_parent_folder ${MINIBUNDLE_EXTERNAL_PATH}/${lib_folder})
...
function(add_simple_external_library_with_sources lib_target_name lib_folder)
    ...
    set(lib_inner_folder ${MINIBUNDLE_EXTERNAL_PATH}/${lib_folder}/${lib_folder})
...
function(add_additional_sources_to_external_library lib_target_name lib_folder additional_sources_folder)
    set(lib_additional_folder ${MINIBUNDLE_EXTERNAL_PATH}/${lib_folder}/${additional_sources_folder})
